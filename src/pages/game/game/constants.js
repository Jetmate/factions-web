...
export const
  ...
  LEADERBOARD_SIZE = [ELEMENT_WIDTH, ELEMENTS_HEIGHT],
  LEADERBOARD_ROW_NUMBER = 10,
  LEADERBOARD_ROW_PADDING = 10,
  LEADERBOARD_PADDING = 10,
  LEADERBOARD_ROW_HEIGHT = (LEADERBOARD_SIZE[1] - LEADERBOARD_PADDING * 2) / LEADERBOARD_ROW_NUMBER - LEADERBOARD_ROW_PADDING,
